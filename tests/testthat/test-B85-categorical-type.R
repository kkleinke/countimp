## B85: the categorical base methods must return the same TYPE they were given.
##
## Numbered B85, not B83: this block arrived from the parallel session working
## on simulationen/, which had reached B83 independently while B83/B84 were
## already taken by the censored and two-level COM-Poisson families. The finding
## itself is theirs.
##
